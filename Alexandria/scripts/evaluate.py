import pandas as pd
import numpy as np
from multiple_choice_question import generate_multiple_choice_question
from extract_answers import answer_questions
from equalize_list_length import equalize_list_lengths
...
def evaluate_peformance(df, number_of_questions, file_name_save_questions):
    ...
    for i in range(len(text_questions_answers_dict_list)):
        ...
        base_cap = evaluate_answers(correct_answers_short, no_context_answers_short)
        ...
        original_cap = evaluate_answers(correct_answers_short, original_context_answers_short)
        ...
        knowledgegraph_cap = evaluate_answers(correct_answers_short, knowledgegraph_context_answers_short)
        ...
        reconstruction_cap = evaluate_answers(correct_answers_short, reconstruction_context_answer_short)
...
def evaluate_answers(correct_answers, received_answers):
    """
